...
#######################################################################################################################
#
#	>>> Sample implementation for bash bootcamp exercise highlow.sh
#   >>> which plays the well known high low game 
#
#######################################################################################################################
#
...
if ((!demo)); then
   if ((myTrials == trialCount)); then
      ...
      echo "You are $((myTrials - trialCount)) trials worse than computer"
   else
      echo "You are $((trialCount - myTrials)) trials better than computer"
   fi
fi
