...
#######################################################################################################################
#
#	>>> Sample implementation for bash bootcamp exercise wheatherin.sh
#   >>> which retrieves coordinates of a city and retrieves temperature and windspeed and -direction
#
#######################################################################################################################
#
